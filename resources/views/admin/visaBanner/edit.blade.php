...
@section('content')
    ...
    <div class="my-4">
        ...
        <form action="{{ route ('admin.visaBanner.update', $obj->id) }}" method="post" enctype="multipart/form-data">
            {!! method_field('PUT') !!}
            {!! csrf_field() !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="mb-3">
                        @if($obj->img)
                            <img src="{!! Request::root() !!}{!! Storage::disk('local')->url("visaBanner/admin/".$obj->img) !!}"
                                 alt="{{ $obj->img }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="mb-3">
                        @if($obj->img_ru)
                            <img src="{!! Request::root() !!}{!! Storage::disk('local')->url("visaBanner/admin/".$obj->img_ru) !!}"
                                 alt="{{ $obj->img_ru }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="mb-3">
                        @if($obj->img_en)
                            <img src="{!! Request::root() !!}{!! Storage::disk('local')->url("visaBanner/admin/".$obj->img_en) !!}"
                                 alt="{{ $obj->img_en }}"

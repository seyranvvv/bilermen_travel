...
@section('content')
    <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('admin.country.create') }}" class="btn btn-sm btn-danger">
...
<td>{!! $obj->order !!}</td>
                ...
                <td>@if($obj->img)
                        <img src="{!! Request::root() !!}{!! Storage::disk('local')->url("country/image/".$obj->img) !!}" width="150px">
                    @else
                ...
                <td>
                    <a href="{{ route('admin.country.edit', $obj->id) }}" class="btn btn-outline-success btn-sm mb-1">
                        <i class="fas fa-pen"></i>
                    </a>
                    <a href="{{ route('admin.country.ticket.index', $obj->id) }}" class="btn btn-outline-primary btn-sm mb-1">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-right">
                                    <form action="{{ route('admin.country.delete', $obj->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}

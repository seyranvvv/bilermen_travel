...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('admin.country.ticket.create', $country) }}" class="btn btn-sm btn-danger">
            <i class="fas fa-plus"></i> @lang('transFront.tour_ticket')
        </a>
    </div>
...
<td>{!! $obj->order !!}</td>
                ...
                <td>
                    <a href="{{ route('admin.country.ticket.edit', [$country,$obj->id]) }}" class="btn btn-outline-success btn-sm mb-1">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-right">
                                    <form action="{{ route('admin.country.ticket.delete', [$country, $obj->id]) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
